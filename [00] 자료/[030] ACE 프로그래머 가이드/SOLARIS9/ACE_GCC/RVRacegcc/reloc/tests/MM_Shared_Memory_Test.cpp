// MM_Shared_Memory_Test.cpp,v 4.42 2002/12/19 15:59:21 seibel_r Exp
...
ACE_RCSID(tests, MM_Shared_Memory_Test, "MM_Shared_Memory_Test.cpp,v 4.42 2002/12/19 15:59:21 seibel_r Exp")
...
ACE_TMAIN (int, ACE_TCHAR *[])
{
  ...
  if (ACE_OS::mktemp (shm_key) == 0
      || (ACE_OS::unlink (shm_key) == -1
          ...
          && errno == EPERM
#else
          // Unlink normally fails with 'file not found' (2), which should
          // be ignored
          && GetLastError() != 2
#endif
          ))
