 ...
 *
 *  Message_Queue_T.h,v 1.2 2003/01/31 20:07:25 shuston Exp
...
public:
  ...
  /**
   * Retrieve the first @c ACE_MESSAGE_TYPE without removing it.  Note
   * that <timeout> uses <{absolute}> time rather than <{relative}>
   * time.  If the <timeout> elapses without receiving a message -1 is
   * returned and <errno> is set to <EWOULDBLOCK>.  If the queue is
   * deactivated -1 is returned and <errno> is set to <ESHUTDOWN>.
  ...
  /**
   * Enqueue an @c ACE_MESSAGE_TYPE into the <Message_Queue> in
  ...
  /**
   * Enqueue an @c ACE_MESSAGE_TYPE at the end of the queue.  Note
   * that <timeout> uses <{absolute}> time rather than <{relative}>
   * time.  If the <timeout> elapses without receiving a message -1 is
   * returned and <errno> is set to <EWOULDBLOCK>.  If the queue is
   * deactivated -1 is returned and <errno> is set to <ESHUTDOWN>.
  ...
  /**
   * Enqueue an @c ACE_MESSAGE_TYPE at the head of the queue.  Note
   * that <timeout> uses <{absolute}> time rather than <{relative}>
   * time.  If the <timeout> elapses without receiving a message -1 is
   * returned and <errno> is set to <EWOULDBLOCK>.  If the queue is
   * deactivated -1 is returned and <errno> is set to <ESHUTDOWN>.
  ...
  /**
   * Dequeue and return the @c ACE_MESSAGE_TYPE at the head of the
   * queue.  Note that <timeout> uses <{absolute}> time rather than
   * <{relative}> time.  If the <timeout> elapses without receiving a
   * message -1 is returned and <errno> is set to <EWOULDBLOCK>.  If
   * the queue is deactivated -1 is returned and <errno> is set to
  ...
  /**
   * Dequeue and return the @c ACE_MESSAGE_TYPE that has the lowest
   * priority.  Note that <timeout> uses <{absolute}> time rather than
   * <{relative}> time.  If the <timeout> elapses without receiving a
   * message -1 is returned and <errno> is set to <EWOULDBLOCK>.  If
   * the queue is deactivated -1 is returned and <errno> is set to
  ...
  /**
   * Dequeue and return the @c ACE_MESSAGE_TYPE at the tail of the
   * queue.  Note that <timeout> uses <{absolute}> time rather than
   * <{relative}> time.  If the <timeout> elapses without receiving a
   * message -1 is returned and <errno> is set to <EWOULDBLOCK>.  If
   * the queue is deactivated -1 is returned and <errno> is set to
  ...
  /**
   * Dequeue and return the @c ACE_MESSAGE_TYPE with the lowest
