 ...
 *  @file    Vector_T.h
 *
 *  Vector_T.h,v 4.6 2002/10/20 03:02:07 kitty Exp
 *
...
// Forward declaration.
template <class T> class ACE_Vector_Iterator;
...
public:
   ...
   */
  typedef ACE_Vector_Iterator<T> Iterator;
...
protected:
  ...
  friend class ACE_Vector_Iterator<T>;
};
...
public:
  ...
  ACE_Vector_Iterator (ACE_Vector<T> &);
