/* -*- C++ -*- */
// config-hpux-11.00.h,v 1.2 2003/02/19 22:47:43 shuston Exp
// config-hpux-11.00.h,v 1.26 2002/12/13 23:28:43 shuston Exp
...
// macro is not set until A.03.13. If it's not set, set it to 1 - it won't
// be an HP-advertised value, but it will always compare to less than an
// HP-official value, which is probably what we want.
