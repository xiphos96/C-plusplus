...
ACE_RCSID (ace,
           Time_Value,
           "Time_Value.cpp,v 4.7 2002/11/20 06:52:53 ossama Exp")
...
ACE_U_LongLong (0xd53e8000, 0x19db1de);   // This works for x86
# else
const DWORDLONG ACE_Time_Value::FILETIME_to_timval_skew =
ACE_INT64_LITERAL (116444736000000000);
# endif
