/* -*- C++ -*- */
// Mem_Map.i,v 4.13 2002/10/05 00:25:52 shuston Exp
  ...
  if (this->close_handle_)
    {
      ...
      // WinCE kernel takes over file handle when file is successfully mapped
      // and it will close it automatically after last mem map is unmapped
      // and mapping handle closed. For more info on file mapping in WinCE
