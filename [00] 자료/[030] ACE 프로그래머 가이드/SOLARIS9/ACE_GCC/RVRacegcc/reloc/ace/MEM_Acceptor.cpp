// MEM_Acceptor.cpp
// MEM_Acceptor.cpp,v 4.15 2002/10/05 00:25:52 shuston Exp
...
ACE_RCSID(ace, MEM_Acceptor, "MEM_Acceptor.cpp,v 4.15 2002/10/05 00:25:52 shuston Exp")
  ...
  if (this->mmap_prefix_ != 0)
    {
      ...
      const ACE_TCHAR *prefix_fmt = ACE_LIB_TEXT ("%s_%d_");
#else
      const ACE_TCHAR *prefix_fmt = ACE_LIB_TEXT ("%ls_%d_");
