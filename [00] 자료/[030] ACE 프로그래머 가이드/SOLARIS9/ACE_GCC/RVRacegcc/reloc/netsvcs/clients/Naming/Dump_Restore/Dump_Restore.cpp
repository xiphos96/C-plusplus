// Dump_Restore.cpp,v 1.2 2003/03/31 22:02:30 shuston Exp
...
ACE_RCSID(Dump_Restore, Dump_Restore, "Dump_Restore.cpp,v 1.2 2003/03/31 22:02:30 shuston Exp")
                        ...
                        int port)
{
  ...
  ACE_OS::strcpy (this->hostname_, ACE_TEXT_CHAR_TO_TCHAR (hostname));
  this->port_ = port;
  this->ns_scope_ =
