// TS_Server_Handler.cpp,v 1.2 2003/03/31 22:02:31 shuston Exp
...
ACE_RCSID(lib, TS_Server_Handler, "TS_Server_Handler.cpp,v 1.2 2003/03/31 22:02:31 shuston Exp")
...
{
  ACE_TRACE (ACE_TEXT ("ACE_TS_Server_Acceptor::parse_args"));
