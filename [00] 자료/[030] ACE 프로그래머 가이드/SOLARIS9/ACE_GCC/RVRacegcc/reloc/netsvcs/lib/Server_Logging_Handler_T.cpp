// Server_Logging_Handler_T.cpp,v 1.2 2003/03/31 22:02:30 shuston Exp
...
ACE_RCSID(lib, Server_Logging_Handler_T, "Server_Logging_Handler_T.cpp,v 1.2 2003/03/31 22:02:30 shuston Exp")
...
ACE_Server_Logging_Handler_T<ACE_PEER_STREAM_2, COUNTER, ACE_SYNCH_USE, LMR>::handle_logging_record (void)
{
  ...
  switch (this->peer ().recv ((void *) &length,
    ...
    case 0:
      ACE_ERROR_RETURN ((LM_ERROR,
                         ACE_TEXT ("closing log daemon at host %s\n"),
                         this->host_name ()),
                        -1);
      /* NOTREACHED */
    case sizeof length:
