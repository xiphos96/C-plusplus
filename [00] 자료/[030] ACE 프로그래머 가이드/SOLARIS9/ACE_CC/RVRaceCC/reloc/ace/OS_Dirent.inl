// -*- C++ -*-
// OS_Dirent.inl,v 1.2 2003/03/31 22:02:27 shuston Exp
// OS_Dirent.inl,v 4.19 2002/12/08 04:44:58 schmidt Exp
...
#    else /* ! ACE_WIN32 */
  ...
  ACE_TCHAR *nonconst_filename = ACE_const_cast (ACE_TCHAR *, filename);
  return ::opendir (ACE_TEXT_ALWAYS_CHAR (nonconst_filename));
#    endif /* ACE_WIN32 */
#  endif /* ACE_PSOS */
#else
