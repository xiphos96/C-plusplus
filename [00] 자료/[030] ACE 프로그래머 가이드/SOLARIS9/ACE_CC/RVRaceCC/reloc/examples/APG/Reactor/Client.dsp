...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"..\..\..\ace" /nologo /version:5.3 /subsystem:console  /machine:I386 /out:"Client.exe"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"..\..\..\ace" /nologo /version:5.3 /subsystem:console /debug /machine:I386 /out:"Client.exe"
