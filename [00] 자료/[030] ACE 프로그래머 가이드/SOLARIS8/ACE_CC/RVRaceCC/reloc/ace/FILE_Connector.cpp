// FILE_Connector.cpp,v 1.2 2003/03/31 22:02:21 shuston Exp
...
ACE_RCSID(ace, FILE_Connector, "FILE_Connector.cpp,v 1.2 2003/03/31 22:02:21 shuston Exp")
			     ...
			     int perms)
{
  ...
  if (ACE_reinterpret_cast (const ACE_Addr &,
                                            ...
                                            remote_sap)) == ACE_Addr::sap_any)
    {
      ...
      // condition.
      ACE_TCHAR filename[] = ACE_LIB_TEXT ("ace-file-XXXXXX");
