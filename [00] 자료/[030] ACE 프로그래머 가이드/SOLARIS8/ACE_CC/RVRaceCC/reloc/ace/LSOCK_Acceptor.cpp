// LSOCK_Acceptor.cpp,v 1.2 2003/03/31 22:02:22 shuston Exp
...
ACE_RCSID(ace, LSOCK_Acceptor, "LSOCK_Acceptor.cpp,v 1.2 2003/03/31 22:02:22 shuston Exp")
...
ACE_LSOCK_Acceptor::remove (void)
{
  ...
  int unlink_res =
   ACE_OS::unlink (ACE_TEXT_CHAR_TO_TCHAR (this->local_addr_.get_path_name()));
  return (unlink_res == -1 || result == -1) ? -1 : 0;
}
