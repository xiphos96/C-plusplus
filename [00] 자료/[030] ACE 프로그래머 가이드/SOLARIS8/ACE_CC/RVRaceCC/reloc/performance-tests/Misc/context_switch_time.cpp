// context_switch_time.cpp,v 1.2 2003/02/19 22:45:53 shuston Exp
// context_switch_time.cpp,v 4.38 2002/03/14 17:32:48 nanbor Exp
...
ACE_RCSID(Misc, context_switch_time, "context_switch_time.cpp,v 4.38 2002/03/14 17:32:48 nanbor Exp")
...
static ACE_UINT32 iter_count = 1;
  ...
  while ((opt = get_opt ()) != EOF) {
    ...
    case 'c':
      if (ACE_OS::atoi (get_opt.opt_arg ()) >= 0)
        {
          iter_count = ACE_OS::atoi (get_opt.opt_arg ());
        }
      else
        {
