// Client_Logging_Handler.cpp,v 1.2 2003/03/31 22:02:30 shuston Exp
...
ACE_RCSID(lib, Client_Logging_Handler, "Client_Logging_Handler.cpp,v 1.2 2003/03/31 22:02:30 shuston Exp")
...
{
  ACE_TRACE (ACE_TEXT ("ACE_Client_Logging_Handler::get_handle"))
...
ACE_Client_Logging_Acceptor::info (ACE_TCHAR **strp, size_t length) const
{
  ...
  ACE_OS::sprintf (buf, ACE_TEXT ("%d/%s %s"),
		   this->server_addr_.get_port_number (), ACE_TEXT ("tcp"),
		   ACE_TEXT ("# client logging daemon\n"));
