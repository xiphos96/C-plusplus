# Process_Win32.pm,v 1.5 2003/08/08 20:18:47 boris Exp
# Process_Win32.pm,v 1.7 2002/12/10 19:33:02 nanbor Exp
...
#                "/save-data=$basename.pfy ".
        ...
        $cmdline = join(' ', @tokens);
        print SCRIPT "copy $executable 1:\\Windows\\Start Menu\n";
        print SCRIPT "cd \\Windows\\Start Menu\n";
        ...
        print SCRIPT "del 1:\\Windows\\Start Menu\\$testname.exe\n";
