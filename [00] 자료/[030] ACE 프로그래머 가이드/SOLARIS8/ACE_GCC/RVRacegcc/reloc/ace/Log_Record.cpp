// Log_Record.cpp,v 1.2 2003/03/31 22:02:26 shuston Exp
...
ACE_RCSID(ace, Log_Record, "Log_Record.cpp,v 1.2 2003/03/31 22:02:26 shuston Exp")
      ...
      if (fp != 0)
        {
          ...
          if (ACE_OS::fputs (verbose_msg, fp) == EOF)
            result = -1;
          else
            ACE_OS::fflush (fp);
        }
