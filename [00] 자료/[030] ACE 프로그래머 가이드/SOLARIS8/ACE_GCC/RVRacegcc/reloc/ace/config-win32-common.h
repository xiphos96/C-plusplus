/* -*- C++ -*- */
// config-win32-common.h,v 1.4 2003/07/31 03:42:33 boris Exp
// config-win32-common.h,v 4.173 2003/01/14 19:57:54 shuston Exp
...
#if defined (ACE_HAS_WINCE)
 #define ACE_DEFAULT_THREAD_PRIORITY 3
#else
