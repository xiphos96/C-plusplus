/* -*- C++ -*- */
// Enum_Interfaces_Test.cpp,v 1.4 2003/05/22 20:42:20 shuston Exp
// Enum_Interfaces_Test.cpp,v 4.16 2002/06/30 20:37:23 schmidt Exp
...
ACE_RCSID(tests, Enum_Interfaces_Test, "Enum_Interfaces_Test.cpp,v 1.4 2003/05/22 20:42:20 shuston Exp")
...
ACE_TMAIN (int, ACE_TCHAR *[])
{
  ...
  ACE_utsname uname;
  ACE_OS::uname (&uname);
  // If ACE_LACKS_UTSNAME_T, ACE_utsname's members are ACE_TCHAR, else
  // they're char.
...
#else
  ACE_DEBUG ((LM_DEBUG, ACE_TEXT ("Machine: %s running on %s\n"),
              ACE_TEXT_CHAR_TO_TCHAR (uname.nodename),
              ACE_TEXT_CHAR_TO_TCHAR (uname.machine)));
  ACE_DEBUG ((LM_DEBUG, ACE_TEXT ("Platform: %s, %s, %s\n"),
              ACE_TEXT_CHAR_TO_TCHAR (uname.sysname),
              ACE_TEXT_CHAR_TO_TCHAR (uname.release),
              ACE_TEXT_CHAR_TO_TCHAR (uname.version)));
#endif
