========================================================================
    ACTIVE TEMPLATE LIBRARY : AddBack Project Overview
========================================================================

AppWizard has created this AddBack project for you to use as the starting point for
...
AddBack.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (AddBack.h)
        GUID definitions                                (AddBack_i.c)
        A type library                                  (AddBack.tlb)
        Marshaling code                                 (AddBack_p.c and dlldata.c)

AddBack.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in AddBack.idl. It will be regenerated by MIDL during compilation.
AddBack.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named AddBack.pch and a precompiled types file named StdAfx.obj.
...
AddBackps.vcproj
	...
	dlldata.c, AddBack_i.c and AddBack_p.c which are required
