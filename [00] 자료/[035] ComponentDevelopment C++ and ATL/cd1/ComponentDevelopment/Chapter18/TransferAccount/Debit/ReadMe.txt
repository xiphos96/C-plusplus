========================================================================
    ACTIVE TEMPLATE LIBRARY : Debit Project Overview
========================================================================

AppWizard has created this Debit project for you to use as the starting point for
...
Debit.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Debit.h)
        GUID definitions                                (Debit_i.c)
        A type library                                  (Debit.tlb)
        Marshaling code                                 (Debit_p.c and dlldata.c)

Debit.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Debit.idl. It will be regenerated by MIDL during compilation.
Debit.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Debit.pch and a precompiled types file named StdAfx.obj.
...
Debitps.vcproj
	...
	dlldata.c, Debit_i.c and Debit_p.c which are required
