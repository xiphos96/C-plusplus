========================================================================
    ACTIVE TEMPLATE LIBRARY : Credit Project Overview
========================================================================

AppWizard has created this Credit project for you to use as the starting point for
...
Credit.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Credit.h)
        GUID definitions                                (Credit_i.c)
        A type library                                  (Credit.tlb)
        Marshaling code                                 (Credit_p.c and dlldata.c)

Credit.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Credit.idl. It will be regenerated by MIDL during compilation.
Credit.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Credit.pch and a precompiled types file named StdAfx.obj.
...
Creditps.vcproj
	...
	dlldata.c, Credit_i.c and Credit_p.c which are required
