========================================================================
    ACTIVE TEMPLATE LIBRARY : Transfer Project Overview
========================================================================

AppWizard has created this Transfer project for you to use as the starting point for
...
Transfer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Transfer.h)
        GUID definitions                                (Transfer_i.c)
        A type library                                  (Transfer.tlb)
        Marshaling code                                 (Transfer_p.c and dlldata.c)

Transfer.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Transfer.idl. It will be regenerated by MIDL during compilation.
Transfer.cpp
...
Transferps.vcproj
	...
	dlldata.c, Transfer_i.c and Transfer_p.c which are required
