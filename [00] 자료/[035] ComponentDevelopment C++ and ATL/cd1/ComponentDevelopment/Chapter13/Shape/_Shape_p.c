...
/* Object interface: IShape, ver. 0.0,
   GUID={0xB11EC349,0xD82F,0x494B,{0xA5,0x1C,0xB1,0xCD,0xC2,0xDF,0x0E,0xB4}} */
...
CINTERFACE_PROXY_VTABLE(12) _IShapeProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IShape::get_ShapeType */ ,
    (void *) (INT_PTR) -1 /* IShape::put_ShapeType */ ,
    (void *) (INT_PTR) -1 /* IShape::ChangeShape */
};
...
const CInterfaceProxyVtbl * __Shape_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IShapeProxyVtbl,
    0
};

const CInterfaceStubVtbl * __Shape_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IShapeStubVtbl,
    0
};

PCInterfaceName const __Shape_InterfaceNamesList[] = 
{
    "IShape",
    0
};

const IID *  __Shape_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __Shape_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __Shape, pIID, n)

int __stdcall __Shape_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__Shape_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _Shape_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __Shape_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __Shape_StubVtblList,
    (const PCInterfaceName * ) & __Shape_InterfaceNamesList,
    (const IID ** ) & __Shape_BaseIIDList,
    & __Shape_IID_Lookup, 
    1,
    2,
