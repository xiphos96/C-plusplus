...
/* Object interface: IAddBack, ver. 0.0,
   GUID={0xCE06761C,0xAF3B,0x4606,{0xA6,0xE9,0xCF,0x7F,0xE4,0xDA,0x1F,0x2F}} */
...
const CInterfaceProxyVtbl * __AddBack_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IAddBackProxyVtbl,
    0
};

const CInterfaceStubVtbl * __AddBack_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IAddBackStubVtbl,
    0
};

PCInterfaceName const __AddBack_InterfaceNamesList[] = 
{
    "IAddBack",
    0
};

const IID *  __AddBack_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __AddBack_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __AddBack, pIID, n)

int __stdcall __AddBack_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__AddBack_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _AddBack_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __AddBack_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __AddBack_StubVtblList,
    (const PCInterfaceName * ) & __AddBack_InterfaceNamesList,
    (const IID ** ) & __AddBack_BaseIIDList,
    & __AddBack_IID_Lookup, 
    1,
    2,
