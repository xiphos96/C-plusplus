...
/* Object interface: IAddEnd, ver. 0.0,
   GUID={0x6D8A8A88,0xF393,0x4CEB,{0xB5,0x4B,0x7C,0xC5,0xC4,0xF7,0xAC,0xAE}} */
...
static const MIDL_SERVER_INFO IAddEnd_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(7) _IAddEndProxyVtbl = 
{
    &IAddEnd_ProxyInfo,
    &IID_IAddEnd,
...
const CInterfaceStubVtbl _IAddEndStubVtbl =
{
    &IID_IAddEnd,
    &IAddEnd_ServerInfo,
    7,
...
/* Object interface: IAdd, ver. 0.0,
   GUID={0x727F03FE,0xD17C,0x4b35,{0x88,0x22,0xC4,0x11,0xCF,0x06,0x9D,0x4B}} */
...
static const MIDL_SERVER_INFO IAdd_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(5) _IAddProxyVtbl = 
{
    &IAdd_ProxyInfo,
    &IID_IAdd,
    IUnknown_QueryInterface_Proxy,
