...
/* Object interface: IAddBack, ver. 0.0,
   GUID={0xB91E5E26,0x3781,0x4D46,{0xBF,0xA2,0x1A,0x7D,0x44,0xDA,0x3C,0xBF}} */
...
const CInterfaceProxyVtbl * __AddBackAgg_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IAddBackProxyVtbl,
    0
};

const CInterfaceStubVtbl * __AddBackAgg_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IAddBackStubVtbl,
    0
};

PCInterfaceName const __AddBackAgg_InterfaceNamesList[] = 
{
    "IAddBack",
    0
};

const IID *  __AddBackAgg_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __AddBackAgg_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __AddBackAgg, pIID, n)

int __stdcall __AddBackAgg_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__AddBackAgg_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _AddBackAgg_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __AddBackAgg_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __AddBackAgg_StubVtblList,
    (const PCInterfaceName * ) & __AddBackAgg_InterfaceNamesList,
    (const IID ** ) & __AddBackAgg_BaseIIDList,
    & __AddBackAgg_IID_Lookup, 
    1,
    2,
