...
CINTERFACE_PROXY_VTABLE(12) _IAddEndProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IAddEnd::put_Sum */ ,
...
const CInterfaceProxyVtbl * __AddEnd_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IAddEndProxyVtbl,
    0
};

const CInterfaceStubVtbl * __AddEnd_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IAddEndStubVtbl,
    0
};

PCInterfaceName const __AddEnd_InterfaceNamesList[] = 
{
    "IAddEnd",
    0
};

const IID *  __AddEnd_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __AddEnd_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __AddEnd, pIID, n)

int __stdcall __AddEnd_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__AddEnd_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _AddEnd_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __AddEnd_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __AddEnd_StubVtblList,
    (const PCInterfaceName * ) & __AddEnd_InterfaceNamesList,
    (const IID ** ) & __AddEnd_BaseIIDList,
    & __AddEnd_IID_Lookup, 
    1,
    2,
