...
public:
    ...
    // 연락처 정보 입력
    void inputContact(const string inName,const string inPhoneNumber,const string inEmail,const string inAddress);
    ...
    // 연락처 수정
    void editContactByIndex(int index,const string *inName, const string *inPhoneNumber = NULL, const string *inEmail = NULL,const string *inAddress = NULL);
