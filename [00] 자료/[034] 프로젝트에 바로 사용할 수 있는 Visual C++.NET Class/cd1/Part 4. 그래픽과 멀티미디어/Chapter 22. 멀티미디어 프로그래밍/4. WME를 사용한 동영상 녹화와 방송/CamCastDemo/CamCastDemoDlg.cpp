...
BOOL CCamCastDemoDlg::OnInitDialog()
{
	...
	if(!m_CamCast.Initialize())
	{
		...
		MessageBox("미디어 인코더를 초기화할 수 없습니다.");
	}
	else
	{
		GetDlgItem(IDC_STOP_BUTTON)->EnableWindow(FALSE);
