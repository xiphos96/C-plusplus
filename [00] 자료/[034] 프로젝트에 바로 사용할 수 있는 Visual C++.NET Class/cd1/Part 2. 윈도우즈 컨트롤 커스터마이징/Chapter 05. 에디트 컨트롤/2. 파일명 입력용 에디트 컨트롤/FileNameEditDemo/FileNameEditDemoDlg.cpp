...
void CFileNameEditDemoDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	// CFildNameEdit클래스를 사용하여 DDX/DDV를 실행하기 위한 함수
