...
CBitmapDialogDlg::CBitmapDialogDlg(CWnd* pParent /*=NULL*/)
	: CImageDialog(CBitmapDialogDlg::IDD, pParent)
{
...
void CBitmapDialogDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Radio(pDX, IDC_MODE_RADIO1, m_nBkgndMode);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CBitmapDialogDlg, CImageDialog)
	//{{AFX_MSG_MAP(CBitmapDialogDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_MODE_RADIO1, OnModeRadio1)
	ON_BN_CLICKED(IDC_MODE_RADIO2, OnModeRadio2)
	ON_BN_CLICKED(IDC_MODE_RADIO3, OnModeRadio3)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()


// CBitmapDialogDlg 메시지 처리기
...
void CBitmapDialogDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CBitmapDialogDlg::OnModeRadio1() 
{
	SetBkgndMode(MODE_CENTER);
}

void CBitmapDialogDlg::OnModeRadio2() 
{
	SetBkgndMode(MODE_TILE);
}

void CBitmapDialogDlg::OnModeRadio3() 
{
