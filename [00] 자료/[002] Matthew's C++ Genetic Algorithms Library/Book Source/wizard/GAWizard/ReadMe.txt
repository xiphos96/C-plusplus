========================================================================
                    CUSTOM APPWIZARD: GAWizard
========================================================================


AppWizard has created a GAWizard DLL for you.  This DLL is the starting point
...
you build GAWizard.awx, it will automatically be copied to your Template
...
GAWizardAw.h, GAWizardAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CGAWizardAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into GAWizard.rc.  Be
...
StdAfx.h, StdAfx.cpp
    ...
    named GAWizard.pch and a precompiled types file named StdAfx.obj.
